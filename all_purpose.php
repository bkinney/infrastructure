...
//end site paths
include "/home/bkinney/includes/lti_mysqli.php";//not the right home
include("/www/canvas/apptracker.php");//push record into db, so we will know what users to notify
